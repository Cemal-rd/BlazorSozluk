...
public class Worker : BackgroundService
{
    ...
    private readonly User.Services.UserService userService;
    private readonly EmailService emailService;

    public Worker(ILogger<Worker> logger, User.Services.UserService userService, EmailService emailService)
    {
        _logger = logger;
